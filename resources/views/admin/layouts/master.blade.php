...
<head>
    ...
    <!-- Bootstrap 4 RTL -->
    <link rel="stylesheet" href="{{asset('/dist/css/rtl/bootstrap.min.css')}}">
...
<!-- Bootstrap 4 rtl -->
<script src="{{asset('dist/js/rtl/bootstrap.min.js')}}"></script>
...
<script>
    $(function () {
       ...
       $('select[name="category_id"]').on('change',function (){
           ...
           if (catId){
               $.ajax({
                   url:'{{url('admin/subcategories/')}}/'+catId+'/all',
                   type:"GET",
                   data:"json",
               ...
               $('select[name="subcategory_id"]').append('<option value="">'+EmptyData+'</option>');
           }
       });
    });
</script>
